...
| Nouvelle gate                 | `yarn check:hook`                     | le hook n'avait aucune couverture : une règle vérifiée une fois n'est pas une garantie, elle finit par mentir — ce qu'elle avait déjà fait                                                                                                              |
