...
Aucun test contre le vrai backend ne pouvait trouver ça : ce backend ne renvoie jamais 500 et ne se coupe pas. Il a fallu fabriquer la panne. Même méthode, deuxième trouvaille : un montant négatif s'affichait `--$5.00`. Celui-là, je l'ai corrigé.
